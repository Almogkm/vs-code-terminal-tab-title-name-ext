...
- In SKILLS.md: list initial skills you will need (VS Code extension anatomy, terminal shell integration, OSC title sequences, parsing command lines, secure-by-default coding).
...
- In DECISIONS.md: record initial design hypotheses (use terminal title sequences + ${sequence}; detect command starts with terminal shell execution events; parse command line deterministically).
